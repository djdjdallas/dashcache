...
import { Camera, Car, ChevronRight, DollarSign, Shield, Upload, Lock, CheckCircle, Eye, Users, Zap, BadgeCheck, FileType, Monitor } from "lucide-react"
            ...
            <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Turn your existing dashcam footage into passive income. Simply upload your rideshare videos - we handle the AI processing and anonymization. Earn $30-100/month from footage you're already recording.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link href="/auth">
                  <Button size="lg" variant="outline" className="border-purple-500 text-purple-500 hover:bg-purple-950 text-lg px-8 py-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center p-3 rounded-lg bg-gray-900/50 backdrop-blur border border-gray-800">
                  <StatsCounter end={2500} suffix="+" className="text-xl font-bold text-blue-500" />
                  <span className="text-xs text-gray-400">Active Drivers</span>
                </div>
                <div className="flex flex-col items-center p-3 rounded-lg bg-gray-900/50 backdrop-blur border border-gray-800">
                  <StatsCounter prefix="$" end={89} className="text-xl font-bold text-purple-500" />
                  <span className="text-xs text-gray-400">Avg Monthly</span>
                </div>
                <div className="flex flex-col items-center p-3 rounded-lg bg-gray-900/50 backdrop-blur border border-gray-800">
                  <StatsCounter end={45} suffix="K" className="text-xl font-bold text-green-500" />
      ...
      <section className="py-16 md:py-24 bg-gray-950/50">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-16">
            <Card className="bg-gray-900 border-gray-800 relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center">1. Upload Your Files</h3>
                <p className="text-gray-400 text-center mb-4">Upload your existing dashcam files (MP4, MOV, AVI). No special equipment or direct camera connection needed.</p>
                <div className="flex justify-center space-x-2 text-xs text-gray-500">
                  <span className="bg-gray-800 px-2 py-1 rounded">Drag & Drop</span>
                  <span className="bg-gray-800 px-2 py-1 rounded">Bulk Upload</span>
                </div>
            ...
            <Card className="bg-gray-900 border-gray-800 relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center">2. AI Processing</h3>
                <p className="text-gray-400 text-center mb-4">Our AI detects vehicles, pedestrians, traffic signs, lane changes, and road conditions while anonymizing all faces and license plates.</p>
                <div className="grid grid-cols-2 gap-1 text-xs text-gray-500">
                  <span className="bg-gray-800 px-2 py-1 rounded text-center">Vehicle Detection</span>
                  <span className="bg-gray-800 px-2 py-1 rounded text-center">Lane Analysis</span>
                  <span className="bg-gray-800 px-2 py-1 rounded text-center">Sign Recognition</span>
                  <span className="bg-gray-800 px-2 py-1 rounded text-center">Privacy Blur</span>
                </div>
            ...
            <Card className="bg-gray-900 border-gray-800 relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-center">3. Earn Passive Income</h3>
                <p className="text-gray-400 text-center mb-4">Get paid directly for uploading quality dashcam footage. Earn $30-100 monthly without changing your routine - just upload your existing videos.</p>
                <div className="flex justify-center space-x-2 text-xs text-gray-500">
                  <span className="bg-gray-800 px-2 py-1 rounded">Direct Payments</span>
                  <span className="bg-gray-800 px-2 py-1 rounded">Upload & Earn</span>
                </div>
          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 border border-gray-800">
            <h3 className="text-2xl font-bold text-center mb-8">AI Detection in Action</h3>
            <AIDetectionDemo />
          </div>
        </div>
      </section>
          ...
          <Tabs defaultValue="drivers" className="w-full">
            <div className="flex justify-center mb-8">
              <TabsList className="bg-gray-900">
                <TabsTrigger value="drivers" className="data-[state=active]:bg-blue-600">
                  For Drivers
                </TabsTrigger>
                <TabsTrigger value="buyers" className="data-[state=active]:bg-purple-600">
                  For Buyers
                </TabsTrigger>
              </TabsList>
            </div>
              ...
              <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-400">
                    Turn your everyday driving into a steady stream of passive income with minimal effort
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Earn $30-100 monthly without changing your routine</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="rounded-full bg-blue-500/10 p-1 mt-1">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">All footage is anonymized to protect you and others</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="rounded-full bg-blue-500/10 p-1 mt-1">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Monitor your earnings and footage status in real-time</p>
                      </div>
                    </li>
                  </ul>
                  <div className="pt-4">
            ...
            <TabsContent value="buyers" className="mt-0">
              <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                ...
                <div className="space-y-4 order-1 lg:order-2">
                  ...
                  <p className="text-gray-400">
                    Access diverse, real-world driving data to train and improve your autonomous systems
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Access footage from various environments and conditions</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="rounded-full bg-purple-500/10 p-1 mt-1">
                      ...
                      <div>
                        <h3 className="font-medium">Pre-processed & Anonymized</h3>
                        <p className="text-sm text-gray-400">All data is cleaned, tagged, and privacy-compliant</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="rounded-full bg-purple-500/10 p-1 mt-1">
                      ...
                      <div>
                        <h3 className="font-medium">Scenario-specific Filtering</h3>
                        <p className="text-sm text-gray-400">Find exactly the training data your models need</p>
                      </div>
                    </li>
                  </ul>
                  <div className="pt-4">
                    <div className="mb-4 p-3 bg-gray-900 rounded-lg">
                      ...
                      <p className="text-xs text-gray-400">Urban Intersections: 500 hours • $200/hour</p>
                      <p className="text-xs text-gray-400">Highway Merging: 300 hours • $180/hour</p>
                    </div>
                    <Link href="/auth">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-400 md:text-xl mx-auto">
                Join thousands of drivers and leading autonomous vehicle companies
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
            <div className="flex flex-col items-center p-4 rounded-lg bg-gray-900/50">
              <StatsCounter end={2500} suffix="+" className="text-2xl font-bold text-blue-500" />
              <span className="text-sm text-gray-400">Total Drivers</span>
            </div>
            <div className="flex flex-col items-center p-4 rounded-lg bg-gray-900/50">
              <StatsCounter prefix="$" end={89} className="text-2xl font-bold text-purple-500" />
              <span className="text-sm text-gray-400">Avg Earnings</span>
            </div>
            <div className="flex flex-col items-center p-4 rounded-lg bg-gray-900/50">
              <StatsCounter end={45000} suffix="+" className="text-2xl font-bold text-green-500" />
              <span className="text-sm text-gray-400">Hours of Footage</span>
            </div>
            <div className="flex flex-col items-center p-4 rounded-lg bg-gray-900/50">
              <StatsCounter end={12} className="text-2xl font-bold text-blue-500" />
          ...
          <div className="mt-16">
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="h-12 w-32 bg-gray-800 rounded-md flex items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2 max-w-3xl">
              ...
              <p className="text-gray-300 md:text-xl">
                Join DashCache today and start earning passive income from your dashcam footage or access high-quality
                training data for your autonomous systems.
              </p>
            </div>
